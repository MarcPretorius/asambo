...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Cloud TS | CLIENT PANEL</title>
			...
			<div class="clearfix"></div>
                    ...
                    <div class="row">
						<div class="site-info col-md-6">
                            <p class="text-muted">Copyright &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}">{!! $company->company_name !!}</a>. All rights reserved. Powered by <a href="http://www.jamarservices.co.za/">Jamar Services</a></p>
                        </div>
					</div>
		</footer><!-- #colophon -->
                    <!-- jQuery 2.1.1 -->
