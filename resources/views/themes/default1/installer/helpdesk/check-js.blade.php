...
@section('content')
    ...
    <noscript>
        ...
        <div class="woocommerce-message woocommerce-tracker" >
                ...
                <p style="font-size:1.0em">Hello, Sparky! You are just a few steps away from your support system. It looks like that JavaScript is not supported or disabled in your browser. CloudTS doesn't work properly without JavaScript, and it may cause errors in installation process. Please check and enable JavaScript in your browser in order to install and run CloudTS to its full extent.</p>
