    ...
    <body class="skin-yellow sidebar-mini layout-fixed layout-navbar-fixed text-sm">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar elevation-4 sidebar-dark-orange">
                ...
                <a href="http://cloudts.jamarservices.co.za" class="brand-link navbar-orange" style="text-align: center;">
            ...
            <footer class="main-footer">
                ...
                <span style="font-weight: 500">{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}" target="_blank">{!! $company->company_name !!}</a>.</span> {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="http://www.jamarservices.co.za" target="_blank">Jamar Services</a>
            </footer>
        </div><!-- ./wrapper -->
